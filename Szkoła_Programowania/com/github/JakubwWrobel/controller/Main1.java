...
public class Main1 {
    ...
    private static SolutionController solutionController = new SolutionController();
...
/*                //Panel ADMIN
                //DODAĆ VALIDACJE PASSWORD
                System.out.println("Wybierz panel do którego chcesz przejść: ");
                System.out.println("1 - Użytkownicy | 2 - Grupy Użytkowników | 3 - Zadania | 4 - Rozwiązania");
                userInput = Checking.checkingString(scanner.nextLine());
                    ...
                    if (userInput.equals("1")) {
                        ...
                        switch (userInput) {
                            ...
                            default:
                                ...
                                System.out.println("Wybierz zadanie, które chcesz wykonać: ");
                                System.out.println("1 - Dodać Użytkownika | 2 - Zaktualizować dane użytkownika | 3 - Przypisać/Zaaktualizować Użytkownikowi Grupę |4 - Wyświetlić Użytkownika | 5 - Znaleźć wszystkich użytkowników po numerze grupy | 6 - Pokazać wszystkich użytkowników | 10 - Wróć Do Panelu Administratora");
                                userInput = Checking.checkingString(scanner.nextLine());
                                break;
                        }
